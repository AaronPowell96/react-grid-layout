...
export function findOrGenerateResponsiveLayout(
  ...
  const reduced = layouts[breakpoint].reduce((acc, current) => {
  ...
  if (layouts[breakpoint]) {
    console.log("USING LAYOUT:", layouts[breakpoint]);
    console.log(
      "LAYOUT CLONED FROM USING LAYOUT",
      cloneLayout(layouts[breakpoint])
    );
    return cloneLayout(layouts[breakpoint]);
  }

  console.log("COULDNT FIND LAYOUT FOR", breakpoint, "IN:", layouts);
  ...
  console.log("NEW GENERATED LAYOUT", layout);
